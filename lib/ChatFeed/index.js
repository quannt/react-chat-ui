...
var ChatFeed = function (_React$Component) {
    ...
    _createClass(ChatFeed, [{
        ...
        value: function renderGroup(key, messages, index, id) {
            ...
            return React.createElement("div", { key: key, style: styles_1.default.chatbubbleWrapper }, messageNodes);
        }
    }, {
        key: "renderMessages",
        value: function renderMessages(messages) {
            ...
            if (isTyping) {
                messageNodes.push(React.createElement("div", { key: "isTyping", style: Object.assign({}, styles_1.default.chatbubbleWrapper) }, React.createElement(ChatBubble, { message: new Message_1.default({
                        id: 1,
                        message: "...",
                        senderName: "",
                        contentType: "",
